...
public class Enemy_Shady : Enemy
{
    ...
    public ShadyExplosiveState explosiveState { get; private set; }
    #endregion
    ...
    protected override void Awake()
    {
        ...
        deadState = new ShadyDeadState(this, stateMachine, "Die");
        ...
        explosiveState = new ShadyExplosiveState(this, stateMachine, "Explosive", this);
    }
