...
public class ArcherBattleState : EnemyState
{
    ...
    public ArcherBattleState(Enemy _enemyBase, EnemyStateMachine stateMachine, string _animBoolName, Enemy_Archer _enemy) : base(_enemyBase, stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
